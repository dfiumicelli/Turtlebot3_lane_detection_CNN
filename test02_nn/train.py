# train_FULL_DATASET_STRATEGY.py - TUA STRATEGIA APPLICATA AL DATASET COMPLETO
...
class CorrectedCombinedLoss(nn.Module):
    """Dice Loss + BCE Loss (la tua strategia)"""
...
def main():
    ...
    print("=" * 60)
    print("🚀 TRAINING U-NET - FULL DATASET (Training + Test Set)")
